...
def scenario1(t1,t2,tempspause,phase):
    ...
    if temps<=3 and phase==2:
        ennemi.append(niveau.Niveau.genererMob(0,atome.AntiCarbone(0,0,0),PatternCibler(100,100)))
        ennemi.append(niveau.Niveau.genererMob(0,atome.AntiCarbone(768,0,0),Pattern(568,100)))
        phase=3
    if temps>9 and phase==3:
        ennemi.append(niveau.Niveau.genererMob(0,atome.AntiAzote(370,0,0),Pattern(0,0.5)))
        phase=4
    if temps>19 and temps<=24 and phase==4:
        ennemi.append(niveau.Niveau.genererMob(0,atome.AntiOxygene(0,0,0),PatternPolynome(2/1000,5/1000,300)))
        ennemi.append(niveau.Niveau.genererMob(0,atome.AntiOxygene(768,0,0),PatternPolynome(2/1000,5/1000,-300)))
        ennemi.append(niveau.Niveau.genererMob(0,atome.AntiHydrogene(0,100,0),Pattern(1,0)))
...
def scenario2(t1,t2,tempspause,phase):
    ennemi=[]
    if phase==2:
        ennemi.append(niveau.Niveau.genererMob(0,atome.AntiRoger(300,30,0),Pattern(0,0)))
        phase=True
    else:
        phase=True
