...
class Menu :
    ...
    def init(self, liste, dest_surface,orientation=0):
        self.liste = []
        self.pola = []
        self.taille_ecriture = 40
        self.police_ecriture = 'resources/polices/zawijasy.otf'
        self.font = pygame.font.Font
        self.dest_surface = pygame.Surface
        self.couleur_texte =  (255, 255, 100)
        self.couleur_selection = (200,0,100)
        self.position = 0
        self.position_affichage = (13,50)
        self.largeur = 0
        self.hauteur = 0
        ...
        for i in range(self.position+1):
            ...
            if self.position==0:
                if type(self.pola[i].texte)==type('s'):
                    ...
                    self.pola[0].zone_menu = self.liste[0]
        for i in range(self.nombre_d_options):
    ...
    def structure(self):
        ...
        for i in range(self.nombre_d_options):
            ...
            if self.orientation==0:
                ...
                self.pola[i].zone_rect.left = deplacer+(deplacer*2+height)*i
                self.pola[i].zone_rect.top = deplacer
