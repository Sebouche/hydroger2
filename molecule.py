...
def listerAtomes( nomMol,hauteur,largeur):
        ...
        for y in range(hauteur):
            for x in range(largeur):
                ...
                if pixel == (0,1,0,255):
                    listeAtomes.append(Carbone(x,y,pattern))
                elif pixel == (0,0,1,255):
                    listeAtomes.append(Hydrogene2(x,y,pattern))
                elif pixel == (1,0,0,255):
                    listeAtomes.append(Oxygene(x,y,pattern))
                elif pixel == (0,1,1,255):
                    listeAtomes.append(Azote(x,y,pattern))
                elif pixel == (1,0,1,255):
                    listeAtomes.append(Chlore(x,y,pattern))
                elif pixel == (1,1,2,255):
                    listeAtomes.append(Soufre(x,y,pattern))
                elif pixel == (2,1,2,255):
                    listeAtomes.append(Fluor(x,y,pattern))
                elif pixel == (1,1,0,255):
                    listeAtomes.append(Boson(x,y,pattern))
